        ...
        <div class="col-sm-12 prohead">
           ...
           <a href="/"><img src="__ROOT__/Public/img/logo_02.png" alt=""></a>
            ...
            <div class="col-sm-7.5" id="nav">
                <ul>
                    <li><a href="/company" style="line-height: 66px;"><img src="__ROOT__/Public/img/shouye_logo1.ico" alt=""  style="padding-right: 4px;">公司</a></li>
                    <li><a href="/product" style="line-height: 66px;"><img src="__ROOT__/Public/img/chanping_logo1.ico" alt=""  style="padding-right: 4px;">产品</a></li>
                    <li><a href="/video" style="line-height: 66px;"><img src="__ROOT__/Public/img/shp_logo1.ico" alt=""  style="padding-right: 4px;">视频</a></li>
                    <li><a href="/news" style="line-height: 66px;"><img src="__ROOT__/Public/img/xinwen_logo1.ico" alt=""  style="padding-right: 4px;">新闻</a></li>
                    <li><a href="/service" style="line-height: 66px;"><img src="__ROOT__/Public/img/fuwu_logo1.ico" alt=""  style="padding-right: 4px;">服务</a></li>
                    <li><a href="/connect" style="line-height: 66px;"><img src="__ROOT__/Public/img/dianhua_logo1.ico" alt=""  style="padding-right: 4px;">联系</a></li>
                </ul>
            </div>
