    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item active">
                <img src="__ROOT__/Public/{$list3.image}"  style="width: 100%;">
            </div>
            <volist id="rows2" name="list2">
            <div class="item">
                <img src="__ROOT__/Public/{$rows2.image}"  style="width: 100%;">
            </div>
            </volist>
        </div>
...
<div class="hidden-lg">
    ...
    <div>
        <volist name="list5" id="rows4">
            <div>
                <a href="/con/a/?id={$rows4.info_id}">
                    <div class="cc" style="width: 25%;background-color: #fff;line-height: 58px;height: 225px;padding-left: 16px; float: left;color: #0f0f0f;border-left: 1px solid #f0f0f0;" onmouseover="navinfo('a{$rows4.id}')" onmouseout="outnav('a{$rows4.id}')" id="a{$rows4.id}">
                        <span style="font-size: 16px;">{$rows4.title}</span>
                        <img src="__ROOT__/Public/{$rows4.image}" style="padding: 20px 13px 37px 13px;width: 100%;">
                    </div>
                </a>
        ...
        <div class="col-sm-12" style="margin: 0px;padding: 0px;">
            <div class="col-sm-3" style="padding:0px;margin:0px;padding-right: 12px;padding-left: 0px;">
                <div style="padding-bottom: 15px;">
                    <a href="/news"><span style="color: #005bac;font-size: 16px;">最新动态</span></a>
                </div>
                <img src="__ROOT__/Public/{$data.title_img}" style="width: 100%;">
                <div style="font-size: 14px;line-height: 34px;"><a href="/news/a/?id={$data.id}" style="color: #0f0f0f;">{$data.title}</a></div>
                <div style="color: #5f6060;line-height: 20px;">{$data.create_time} | {$data.author} | {$data.click}</div>
                <a href="/news/a/?id={$data.id}"><p style="color: #323232;line-height: 18px;padding-top: 6px;font-size: 12px;">{$data.small_content}</p></a>
                <a href="/news" style="color:#009cff; padding-top: 10px;">更多</a>
            </div>
            <div class="col-sm-3" style="padding0px;margin0px;padding-right: 12px;padding-left: 0px;padding-top: 34px;">
                <ul class="col-sm-12" style="padding: 0px;margin: 0px;">
                    <volist id="rows" name="list">
                    <li style="float: left;width: 100%;line-height: 20px;">
                        <a href="/news/a/?id={$rows.id}" style="font-size: 12px;float: left;color: #323232;">{$rows.title}</a>
                        <a href="#" style="font-size: 12px;float: right;color: #323232;;">{$rows.create_time}</a>
                    </li>
                    </volist>
                </ul>
                <a href="/news/" style="color:#009cff; padding-top: 10px;font-size: 12px;">更多</a>
            </div>
            <div class="col-sm-3" style="padding:0px;margin:0px;padding-right: 12px;padding-left: 0px;">
                <div style="padding-bottom: 15px;">
                    <a href="/company"><span style="color: #005bac;font-size: 16px;">公司信息</span></a>
                </div>
                <img src="__ROOT__/Public/img/mianing_img02_28.png" style="width: 100%;">
                <div style="font-size: 16px;color: #005bac;line-height: 24px;">振兴绿色包装—<br />我们的技术之翼与革新之志 </div>
                <ul style="padding-left: 0px;">
                    <li style="color: #323232;line-height: 18px;font-size: 14px;">地址：浙江温州瑞安巾子山路6号</li>
                    <li style="color: #323232;line-height: 18px;font-size: 14px;">手机：013074681888</li>
                    <li style="color: #323232;line-height: 18px;font-size: 14px;">电话：0577-65888482、65888481</li>
                    <li style="color: #323232;line-height: 18px;font-size: 14px;">传真：0577-65888480</li>
                    <li style="color: #323232;line-height: 18px;font-size: 14px;">邮编：325200</li>
                </ul>
            </div>
            <div class="col-sm-3" style="padding:0px;margin: 0px;padding-right: 0px;padding-left: 0px;">
                <div style="padding-bottom: 15px;">
                <a href="/connect"><span style="color: #005bac;font-size: 16px;">视频中心</span></a>
                </div>
