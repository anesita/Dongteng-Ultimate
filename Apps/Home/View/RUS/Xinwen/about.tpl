...
<div class="visible-lg">
    <div class="container">
        <div>
            <h1 style="margin: 0px;font-size: 32px;">{$list.rus_title}</h1>
            ...
            <p style="padding-top: 32px;">
                {$list.rus_content||htmlspecialchars_decode}
            </p>
        </div>
    </div>
</div>
...
<div class="hidden-lg">
    <div class="container" style="width: 96%;">
        <div style="padding-top: 68px;">
            <h1 style="font-size: 3.8rem;margin: 0px;">{$list.rus_title}</h1>
            ...
            <p>
                <div style="font-size: 2.8rem;line-height: 3.6rem;"> {$list.rus_content}</div>
            </p>
        </div>
    </div>
</div>
