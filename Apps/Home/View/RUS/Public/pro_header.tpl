    ...
    <div style="padding: 0px;">
        <div class="col-sm-12 prohead">
            ...
            <div class="col-sm-7.5" id="nav">
                <ul>
                    <li><a href="/company" style="line-height: 66px;"><img src="__ROOT__/Public/img/shouye_logo1.ico" alt=""  style="padding-right: 4px;">О нас</a></li>
                    <li><a href="/product" style="line-height: 66px;"><img src="__ROOT__/Public/img/chanping_logo1.ico" alt=""  style="padding-right: 4px;">Товары</a></li>
                    <li><a href="/video" style="line-height: 66px;"><img src="__ROOT__/Public/img/shp_logo1.ico" alt=""  style="padding-right: 4px;">Видео</a></li>
                    <li><a href="/news" style="line-height: 66px;"><img src="__ROOT__/Public/img/xinwrus_logo1.ico" alt=""  style="padding-right: 4px;">Товары</a></li>
                    <li><a href="/service" style="line-height: 66px;"><img src="__ROOT__/Public/img/fuwu_logo1.ico" alt=""  style="padding-right: 4px;">Oбслуживание</a></li>
                    <li><a href="/connect" style="line-height: 66px;"><img src="__ROOT__/Public/img/dianhua_logo1.ico" alt=""  style="padding-right: 4px;">контакт</a></li>
                </ul>
            </div>
