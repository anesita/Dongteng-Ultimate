...
<form action="{:U()}" class="form-horizontal" method="post" enctype="multipart/form-data">
    ...
    <!-- <div id="four_big" style="display: none;position:absolute;right:10px;top:87px;"><img src="__ROOT__/Public/img/guoqi4-1.png" style="width: 60px;"></div> -->
    ...
    <!-- <div id="five_big" style="display: none;position:absolute;right:10px;top:116px;"><img src="__ROOT__/Public/img/guoqi5-1.png" style="width: 60px;"></div> -->
    ...
    <!-- <div id="six_big" style="display: none;position:absolute;right:10px;top:145px;"><img src="__ROOT__/Public/img/guoqi6-1.png" style="width: 60px;"></div> -->
