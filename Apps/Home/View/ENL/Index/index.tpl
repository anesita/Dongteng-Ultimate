        ...
        <div class="col-sm-12" style="margin: 0px;padding: 0px;">
            <div class="col-sm-3" style="padding:0px;margin:0px;padding-right: 12px;padding-left: 0px;">
                <div style="padding-bottom: 15px;">
                    <a href="/news"><span style="color: #005bac;font-size: 16px;">Exhibition & News</span></a>
                </div>
                <a href="/news"><img src="__ROOT__/Public/{$data.title_img}" style="width: 100%;"></a>
                <div style="font-size: 14px;line-height: 34px;"><a href="/news/a/?id={$data.id}" style="color: #0f0f0f;">{$data.en_title}</a></div>
                <div style="color: #5f6060;line-height: 20px;">{$data.create_time} | {$data.author} | {$data.click}</div>
                <a href="/news/a/?id={$data.id}"><p style="color: #323232;line-height: 18px;padding-top: 6px;font-size: 12px;">{$data.en_small_content}</p></a>
                <a href="/news" style="color:#009cff; padding-top: 10px;">More</a>
            </div>
            <div class="col-sm-3" style="padding:0px;margin:0px;padding-right: 12px;padding-left: 0px;padding-top: 34px;">
                <ul class="col-sm-12" style="padding: 0px;margin: 0px;">
                    ...
                    <li style="float: left;width: 100%;line-height: 20px;">
                        <a href="/news/a/?id={$rows.id}" style="font-size: 12px;float: left;color: #323232;">{$rows.en_title}</a>
                        <a href="#" style="font-size: 12px;float: right;color: #323232;;">{$rows.create_time}</a>
                    </li>
                    </volist>
                </ul>
                <a href="/news/" style="color:#009cff; padding-top: 10px;font-size: 12px;">More</a>
            </div>
            <div class="col-sm-3" style="padding:0px;margin:0px;padding-right: 12px;padding-left: 0px;">
                <div style="padding-bottom: 15px;">
                    <a href="/company"><span style="color: #005bac;font-size: 16px;">Company</span></a>
                </div>
                <a href="/company"><img src="__ROOT__/Public/img/mianing_img02_28.png" style="width: 100%;"></a>
                <div style="font-size: 18px;color: #005bac;line-height: 24px;">professional partner of paper mills & converters</div>
                <ul style="padding-left: 0px;padding-top: 14px;">
                    <li style="color: #323232;line-height: 18px;font-size: 12px;">ADD：No. 6, Jinzishan Rd., Rui’An City,Wenzhou, P.C. 325200,Zhejiang Province, China</li>
                    <li style="color: #323232;line-height: 18px;font-size: 12px;">Mobile(whatsapp)：+86-13818631306</li>
                    <li style="color: #323232;line-height: 18px;font-size: 12px;">Tel：+86-577-65888482 65888481</li>
                    <li style="color: #323232;line-height: 18px;font-size: 12px;">Fax.+86-577-65888480</li>
                    <li style="color: #323232;line-height: 18px;font-size: 12px;">Email: leo.chinamachinery@hotmail.com</li>
                </ul>
            </div>
            <div class="col-sm-3" style="padding:0px;margin: 0px;padding-right: 0px;padding-left: 0px;">
                <div style="padding-bottom: 15px;">
                    <a href="/connect"><span style="color: #005bac;font-size: 16px;">Video Center</span></a>
                </div>
