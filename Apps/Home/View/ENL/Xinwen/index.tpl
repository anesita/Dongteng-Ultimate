...
<div class="visible-lg">
    <div class="container"  style="padding-bottom: 390px;">
        <div>
            <h1 style="margin: 0px;font-size: 32px;">Exhibition & Event</h1>
        </div>
        ...
        <div class="col-sm-12" style="margin: 0px;padding: 0px;padding-top: 38px;">
            ...
            <div class="col-sm-6" style="margin: 0px;padding: 0px;padding-left: 26px;">
                <div style="padding-top: 20px;">
                    <h1 style="font-size: 18px;margin: 0px;float: left">{$rows.en_title}</h1><br>
                    <div style="padding-top: 12px;"><span style="font-size: 12px;">{$rows.create_time} Click rate:{$rows.click} Author:{$rows.author}</span></div>
                </div>
                <div style="padding-top: 20px;">
                    <span style="font-size: 14px;padding-top: 28px;">{$rows.en_small_content}</span>
                </div>
