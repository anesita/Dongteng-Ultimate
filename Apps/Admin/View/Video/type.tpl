...
<block name="main">
        ...
        <div class="main">
            ...
            <div  style="padding-bottom: 13px;"><button type="button" id="btn-quick-event" class="btn btn-primary" data-toggle="modal" data-target="#myModal1"><i class="fa fa-plus-square"></i> 添加分类</button></div>
            <!-- Modal -->
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="__MODULE__/chanpin/addtype/" method="post">
                                ...
                                <div><span style="display: inline-block;width: 80px;">所属父栏目:</span>
                            ...
                            <table class="table table-hover">
                                ...
                                <volist name="list" id="tour">
                                    <tr>
                                        ...
                                        <td><a href="" class="btn btn-danger">编辑</a> <a href="__MODULE__/chanpin/deltype/?id={$tour.id}" class="btn btn-success">删除</a></td>
                                    </tr>
                                </volist>
                                </tbody>
                            </table>
